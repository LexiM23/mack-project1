...
Description:
In this app, I wanted students who are learning about geology and tectonic plates learn about volcanoes through different visuals such as:
1. Chart eruptions by year
2. Break down activity evidence by country
3. Map active volcanoes for potential forecasting
4. Show historical eruption frequencies by region dating back to 1800
"""
